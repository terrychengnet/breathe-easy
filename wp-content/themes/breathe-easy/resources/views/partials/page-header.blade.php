  ...
  <div class="home-hero relative flex w-full h-auto md:h-screen bg-cover bg-right md:bg-center min-h-[600px] md:min-h-[800px] border-b-[15px] border-blue-main" 
    ...
    <div class="relative z-30 grid grid-cols-12 gap-1 content-end">
      ...
      <div class="hero-content col-start-2 md:col-start-2 col-span-9 md:col-span-8 text-white">
        ...
        <h1 class="text-[50px] md:text-[80px] lg:text-[90px] xl:text-[110px] font-bold leading-[1] mb-8 md:mb-16">Aircon Cleaning Specialists</h1>
        <h3 class="text-[20px] md:text-[30px] lg:text-[35px] xl:text-[40px] font-light leading-[1.2] md:leading-[1.4] mb-16">Industry-Leading practices & uncompromising integrity,unrivalled customer service, and total customer satisfaction.</h3>
      </div>
