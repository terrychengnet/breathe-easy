@if (is_page_template('template-home.blade.php'))
    <div class="relative flex w-full h-auto md:h-screen bg-cover bg-right md:bg-center min-h-[600px] md:min-h-[800px] border-b-[15px] border-blue-main"
        ...
        <div class="relative z-30 grid grid-cols-12 gap-1 content-end">
            {{-- Hero Content --}}
            <div class="hero-content col-start-2 md:col-start-2 col-span-9 md:col-span-8 text-white">
                <p class="hero-pre-txt uppercase text-[15px] sm:text-[20px] md:text-[25px] font-bold mb-7">
                    GET THE BREATHE-EASY EXPERIENCE
                </p>
                <h1
                    class="text-[50px] md:text-[80px] lg:text-[90px] xl:text-[110px] font-bold leading-[1] mb-8 md:mb-16">
                    Aircon Cleaning Specialists</h1>
                <h3
                    class="text-[20px] md:text-[30px] lg:text-[35px] xl:text-[40px] font-light leading-[1.2] md:leading-[1.4] mb-16">
                    Industry-Leading practices & uncompromising integrity,unrivalled customer service, and total
            ...
            <div class="grid hero-more-wrap col-start-11 col-span-1 place-items-end">
                <span class="cursor-pointer mb-16">
                    <i
                        class="fa-regular fa-circle-arrow-down text-[40px] sm:text-[50px] md:text-[70px] text-white hover:text-blue-second"></i>
                </span>
            </div>
        </div>
