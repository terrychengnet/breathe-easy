<<<<<<< HEAD
<header class="header fixed z-50 left-0 right-0 h-[85px] bg-white/20 ease-in duration-100">
    <div class="container h-[100%] flex justify-between items-center">
        <a class="header-logo w-[270px] h-[62px] justify-self-start" href="{{ home_url('/') }}">
            {{-- <img class="header-logo-img " src="{{ get_template_directory_uri() }}/resources/images/Header-logo.svg"/> --}}
        </a>
