<footer class="bg-blue-second">
    <div class="footer-wrapper container py-20">
        <div class="footer-top grid grid-flow-col text-white">
            ...
            <div class="footer-cols contact-us">
                <div class="contact-us-wrapper bg-blue-main p-6 rounded-2xl grid gap-y-1">
                    ...
                    <div class="mt-7 inline-flex items-center"><i class="fa-regular fa-envelope mr-3 w-8"></i><span
                            class="text-base">info@breathe-easyhk.com</span></div>
                </div>
            </div>
